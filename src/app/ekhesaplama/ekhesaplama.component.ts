...
@Component({
  ...
  templateUrl: './ekhesaplama.component.html',
  styleUrls: ['./ekhesaplama.component.scss'],
})
export class EKHesaplamaComponent implements OnInit {
